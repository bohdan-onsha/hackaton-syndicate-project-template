...
@LambdaHandler(lambdaName = "hackathon-lambda-function-ValidateFilePartFunction",
	roleName = "hackathon-iam-role-DefaultLambdaRole",
	isPublishVersion = true,
	aliasName = "${lambdas_alias_name}",
	memory=256
)
@SqsTriggerEventSource(targetQueue = "hackathon-sqs-queue-table-ValidateFilePartQueue", batchSize = 1)
